<x-app-layout :title="$poktan->exists ? 'Ubah Data Poktan' : 'Tambah Poktan'">
    <section class="panel">
        <p class="form-intro">Data Poktan berstatus Aktif ditampilkan pada informasi publik dan digunakan dalam pemantauan. Pilih Nonaktif bila kelompok tidak lagi beroperasi; datanya tetap tersimpan untuk administrasi.</p>
        <form method="post" action="{{ $poktan->exists ? route('poktans.update', $poktan) : route('poktans.store') }}">
            @csrf
