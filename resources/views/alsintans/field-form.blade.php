    ...
    <section class="panel">
        ...
        <form method="post" enctype="multipart/form-data" action="{{ route('alsintans.update', $alsintan) }}">
            ...
            <div class="form-grid">
                ...
                <div class="field"><label>Foto dari kamera</label><input type="file" name="photo" accept="image/*" capture="environment">@error('photo')<span class="error">{{ $message }}</span>@enderror</div>
